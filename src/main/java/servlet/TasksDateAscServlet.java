...
@WebServlet("/tasksDateAsc")
public class TasksDateAscServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            List<Task> taskList = TaskController.getInstance().getTasksByJournalIdDateAsc(journalId);
            request.setAttribute("taskList", taskList);
            getServletContext().getRequestDispatcher("/tasks.jsp").forward(request, response);
        } catch (ControllerException e) {
            System.out.println("Error! Class: " + TasksDateAscServlet.class.getName() + ". Date: " +
