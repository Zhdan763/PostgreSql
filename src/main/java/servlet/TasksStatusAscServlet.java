...
@WebServlet("/tasksStatusAsc")
public class TasksStatusAscServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            List<Task> taskList = TaskController.getInstance().getTasksByJournalIdStatusAsc(journalId);
            request.setAttribute("taskList", taskList);
            getServletContext().getRequestDispatcher("/tasks.jsp").forward(request, response);
        } catch (ControllerException e) {
            System.out.println("Error! Class: " + TasksStatusAscServlet.class.getName() + ". Date: " +
